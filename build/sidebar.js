...
function serialize(style) {
  let o = {}; // Create an object and convert fields/values so the
...
const VISUAL_INDICATORS = [function outline(style, focusStyle) {
  let hasFocusOutline = focusStyle["outline-style"] !== "none" && parseFloat(focusStyle["outline-width"]) !== "0";
...
let FocusStylesPlugin = __webpack_require__(/*! ./focus */ "./plugins/focus/index.js");
...
module.exports = {
  ...
  experimental: [new A11yTextWand(), new FocusStylesPlugin()]
};
